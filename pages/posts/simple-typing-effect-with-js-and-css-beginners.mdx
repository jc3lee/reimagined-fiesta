...
<Codepen alt={'result'} url={'https://codepen.io/ljc-dev/pen/oNYoyrW?editors=0100'} title={''} />
...
<Codepen alt={'jumping steps'} url={'https://codepen.io/ljc-dev/pen/xxRpwbE?editors=1100'} title={''} />
...
<Codepen alt={'improved result'} url={'https://codepen.io/ljc-dev/pen/rNWYrax?editors=0010'} title={''} />
...
<Codepen alt={'final result'} url={'https://codepen.io/ljc-dev/pen/jOVYPQX?editors=1000'} title={''} />