...
<Codepen alt={'result hamburger menu with no js'} url={'https://codepen.io/ljc-dev/pen/NWxJezy?editors=0100'} title={''} />
...
<Codepen alt={'result'} url={'https://codepen.io/ljc-dev/pen/GRNyGKo?editors=0100'} title={''} />
