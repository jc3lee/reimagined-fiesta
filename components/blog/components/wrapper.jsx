  ...
  return (
    <Layout title={meta.title}>
      ...
      <div className="md:mx-4">
        <div className="md:-mt-16 relative max-w-screen-lg w-full mx-auto flex flex-col lg:flex-row px-4 sm:px-6 py-6 dark:bg-primary-dark-acc bg-primary-acc items-start">
